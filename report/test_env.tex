...
%\begin{figure}[h!]
%	\centering
%  	\subfloat[Messages of length from 0 to 32 bytes (stride 4 bytes).]{\label{tsend_32}\includegraphics[width=0.5\textwidth]{../tests/mpi_comm_perf/pianosa/tsend_4.png}}  
%	\hspace*{20pt}
%  	\subfloat[Messages of length from 0 to 1024 bytes (stride 32 bytes).]{\label{tsend_32}\includegraphics[width=0.5\textwidth]{../tests/mpi_comm_perf/pianosa/tsend_32.png}}  
...
%\begin{figure}[h!]
%	\centering
%  	\subfloat[Messages of length from 0 to 32768 bytes (stride $2^i$).]{\label{tsend_logscale}\includegraphics[width=0.5\textwidth]{../tests/mpi_comm_perf/pianosa/tsend_logscale.png}}  
%	\hspace*{20pt}
%  	\subfloat[Bisection test with 4, 8 and 16 processors.]{\label{bisect_logscale}\includegraphics[width=0.5\textwidth]{../tests/mpi_comm_perf/pianosa/bisect_logscale.png}}  
%	\caption{Performance of blocking send and bisection test.}
%\end{figure}
%
%\begin{figure}[h!]
%	\centering {\label{bcast}\includegraphics[width=0.5\textwidth]{../tests/mpi_comm_perf/pianosa/bcast.png}}  
...
\begin{figure}[p]
	\centering
  	\subfloat[Messages of length from 0 to 32 bytes (stride 4 bytes).]{\label{tsend_32}\includegraphics[width=0.4\textwidth]{../tests/mpi_comm_perf/pianosa/tsend_4.png}}  
	\hspace*{20pt}
  	\subfloat[Messages of length from 0 to 1024 bytes (stride 32 bytes).]{\label{tsend_32}\includegraphics[width=0.4\textwidth]{../tests/mpi_comm_perf/pianosa/tsend_32.png}}  
	\caption{Performance of blocking send between two processes.}
	
	\centering
  	\subfloat[Messages of length from 0 to 32768 bytes (stride $2^i$).]{\label{tsend_logscale}\includegraphics[width=0.4\textwidth]{../tests/mpi_comm_perf/pianosa/tsend_logscale.png}}  
	\hspace*{20pt}
  	\subfloat[Bisection test with 4, 8 and 16 processors.]{\label{bisect_logscale}\includegraphics[width=0.4\textwidth]{../tests/mpi_comm_perf/pianosa/bisect_logscale.png}}  
	\caption{Performance of blocking send and bisection test.}
	
	\centering {\label{bcast}\includegraphics[width=0.4\textwidth]{../tests/mpi_comm_perf/pianosa/bcast.png}}  
	\caption{Performance of broadcast with 4, 8 and 16 processors.}
\end{figure}